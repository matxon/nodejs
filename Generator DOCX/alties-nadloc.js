...
var $company_ru = 'Актюбинский филиал компании «Алтиес Петролеум Интернэшнл Б.В.»';
var $company_kz = '«Алтиес Петролеум Интернэшнл Б.В.» компаниясының Ақтөбе филиалы';

// var $company_ru = 'Атырауский филиал компании «Алтиес Петролеум Интернэшнл Б.В.»';
// var $company_kz = '«Алтиес Петролеум Интернэшнл Б.В.» компаниясының Атырау филиалы';
...
// var $title_doc_kz = '«Алтиес Петролеум Интернэшнл Б.В.» компаниясының Атырау филиалының конкурстық комиссиясының төрағасына';
// var $title_doc_ru =  'Председателю конкурсной комиссии Атырауского филиала компании «Алтиес Петролеум Интернэшнл Б.В.»';

var $tender_name_ru = 'Проведение перфорационных работ в скважинах масторождения «Акжар';
var $tender_name_kz = 'Ақжар» кен орнындағы ұңғымаларда перфорациялық жұмыстарды өткізу';
...
var lots = [
  {
    kaz: "№ 1 лот - «Ақжар» кен орнындағы ұңғымаларда перфорациялық жұмыстарды өткізу»",
    rus: "лот №1 - «Проведение перфорационных работ в скважинах масторождения «Акжар»"
  },
  // {
    // kaz: "№ 2 лот - «Қаратайқыз» кен орнындағы кәсіпшілік-геофизикалық зертеулердің кешені»",
    // rus: "лот №2 - «Выполнение комплекса промыслово-геофизических исследовании на  месторождении «Каратайкыз»"
  // },
  // {
    // kaz: "№ 3 лот - «Әлімбай» кен орнындағы кәсіпшілік-геофизикалық зертеулердің кешені»",
    // rus: "лот №3 - «Выполнение комплекса промыслово-геофизических исследовании на месторождении «Алимбай»"
  // }
];
...
documents.push(
 ...
 lots.forEach( function(value, count) {
  ...
  documents.push( 
    ...
    content_doc_ru: 'Настоящим  подтверждаем,  представленное  обязательство  по  казахстанскому  содержанию  в предлагаемых работах в проводимом ' +  $tender_type_ru +  ' ' + value.rus +'.',
  ...
  // Только для Алтиес Петролеум
  // Гарантийное письмо потенциального поставщика об отсутствии 
  // оснований, запрещающих участвовать
  // в проводимом открытом конкурсе
  {
		template: '2',
		filename: 'Гар.Письмо 8-11-12' + 'Лот ' + index,
		content_title_ru: 'Гарантийное письмо потенциального поставщика об отсутствии оснований, запрещающих участвовать в проводимом ' + $tender_type_ru,
		content_title_kz: '(' + $tender_type_kz + ') қатысуға тиым салатын, негіздің жоқтығы туралы əлеуетті жеткізушінің кепіл хаты',
		content_doc_ru: 'Настоящим гарантируем об отсутствии оснований, запрещающих участвовать в проводимом ' +  $tender_type_ru + ' по закупу работ ' + value.rus + '  указанных в пунктах 3.1), 3.2), 3.3) Конкурсной документации.',
		content_doc_kz: 'Осы арқылы  Конкурстық құжаттаманың 3.1), 3.2) және 3.3) тармақтарында көрсетілген, өткізілетін ' + value.kaz + ' (-' + $tender_type_kz + '-) қатысуға тиым салатын негіздің жоқтығына КЕПІЛДІК БЕРЕМІЗ. ',
    __proto__: head
	},
  ...
  // Гарантийное письмо, подтверждающее согласие потенциального поставщика с существенными условиями проекта договора на каждый ЛОТ отдельно
	{
		template: '2',
		filename: 'СогласованиеДоговора' + ' Лот ' + index,
		content_title_ru: 'ГАРАНТИЙНОЕ ПИСЬМО О СОГЛАСОВАНИИ ДОГОВОРА',
		content_title_kz: 'КЕПІЛ ХАТ ШАРТТЫ КЕЛІСІМДЕУ ТУРАЛЫ',
		content_doc_ru: 'ДАТА: ----------> КУДА: ' + $company_ru + ' -------> КОМУ: Конкурсной комиссии -------> ТЕМА: ' + value.rus + ' -------> Уважаемые господа, --------> В соответствии с требованиями статьи 11.1. Конкурсной документации, настоящим мы полностью принимаем предлагаемый (---исправить окончание--->) ' + $company_ru + ' Проект Договора (Приложение №6 к Конкурсной документации).',
		content_doc_kz: 'КҮНІ: ----------> ҚАЙДА: ' + $company_kz + ' -------> КІМГЕ: Конкурстық комиссияға -------> ТАҚЫРЫП: ' + value.kaz + ' -------> Құрметті мырзалар, -------> Осымен Конкурстық құжаттаманың 11.1. бабының талаптарына сәйкес, біз ' + $company_kz + 'мен ұсынылған Шарт жобасын (Конкурстық құжаттаманың №6 Қосымшасы) толығымен қабылдаймыз.',
    __proto__: head
	});
 });
