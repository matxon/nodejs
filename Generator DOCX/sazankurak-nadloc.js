...
var $title_doc_kz = '«Сазанқұрақ» ЖШС-гі конкурстық комиссиясының төрағасына';
var $title_doc_ru =  'Председателю конкурсной комиссии ТОО «Сазанкурак»';

var $tender_name_ru = '«2015.ОК-85666 - Лот№ 1. Капитальный и подземный ремонт скважин (КРС, ПРС). Лот№ 2. «Геофизические исследования в обсаженном стволе и прострелочно-взрывные работы» Лот№ 3. «Гидродинамические исследования (ГДИС) скважин»';
var $tender_name_kz = '«2015.ОК-85666 - № 1 лот - «Ұңғымаларды күрделі және жер асты жөндеу (ҰКЖ, ҰЖЖ)»;  № 2 лот - «Шегенді оқпандағы геофизикалық зерттеулер және ату-жару жұмыстары»; № 3 лот - «Ұңғымаларды геофизикалық зерттеулер»';
...
var lots = [
  {
    kaz: "№ 1 лот - «Ұңғымаларды күрделі және жер асты жөндеу (ҰКЖ, ҰЖЖ)»",
    rus: "лот №1 - «Капитальный и подземный ремонт скважин (КРС, ПРС)»"
  },
  {
