...
var $title_doc_kz = '«Прикаспиан Петролеум Компани» ЖШС-гі конкурстық комиссиясының төрағасына';
var $title_doc_ru =  'Председателю конкурсной комиссии ТОО «Прикаспиан Петролеум Компани»';

var $tender_name_ru = '«2015.ОК-85751 - Капитальный и подземный ремонт скважин месторождения Мынтеке Южный; Геофизические исследования и перфорация скважин месторождения Мынтеке Южное; Гидродинамические исследования скважин на месторождения Мынтеке Южное; Свабирование на скважинах месторождения Мынтеке Южное»';
var $tender_name_kz = '«2015.ОК-85751 - Мыңтеке кенішінің ұңғымаларын күрделі және жер асты жөндеу жұмыстарын жүргізу; Оңтүстік Мыңтеке кеніші ұңғымаларын геофизикалық зерттеулер және перфорациялау; Оңтүстік Мыңтеке кеніші ұңғымаларын гидродинамикалық зерттеулеу; Оңтүстік Мыңтеке кеніші ұңғымаларында сұйықтықты тарту»';
...
var lots = [
  {
    kaz: "№ 1 лот - «Мыңтеке кенішінің ұңғымаларын күрделі және жер асты жөндеу жұмыстарын жүргізу»",
    rus: "лот №1 - «Капитальный и подземный ремонт скважин месторождения Мынтеке Южный»"
  },
  {
    kaz: "№ 2 лот - «Оңтүстік Мыңтеке кеніші ұңғымаларын геофизикалық зерттеулер және перфорациялау»",
    rus: "лот №2 - «Геофизические исследования и перфорация скважин месторождения Мынтеке Южное»"
  },
  {
    kaz: "№ 3 лот - «Оңтүстік Мыңтеке кеніші ұңғымаларын гидродинамикалық зерттеулеу»",
    rus: "лот №3 - «Гидродинамические исследования скважин на месторождениях Мынтеке Южное»"
  },
  {
    kaz: "№ 4 лот - «Оңтүстік Мыңтеке кеніші ұңғымаларында сұйықтықты тарту»",
    rus: "лот №4 - «Свабирование на скважинах месторождения Мынтеке Южное»"
  }
];
