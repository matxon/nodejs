...
var $title_doc_kz = '«Потенциал Ойл» ЖШС конкурстық комиссиясының төрағасына';
var $title_doc_ru =  'Председателю конкурсной комиссии ТОО «Потенциал Ойл»';

var $tender_name_ru = ' «На выполнение работ по текущему и капитальному ремонту скважин» ';
var $tender_name_kz = ' «Ұңғымаларды күрделі және аңымдағы жөндеу» ';
...
var lots = [
  {
    kaz: "№ 1 лот - «Ұңғымаларды күрделі және аңымдағы жөндеу»",
    rus: "лот №1 - «На выполнение работ по текущему и капитальному ремонту скважин»"
  },
  // {
