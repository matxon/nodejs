...
var $title_doc_kz = '«BNG Ltd» ЖШС конкурстық комиссиясының төрағасына';
var $title_doc_ru =  'Председателю конкурсной комиссии ТОО «BNG Ltd»';

var $tender_name_ru = ' «2015.ОК-83424 Услуги по геофизическому исследованию скважин, перфорированию и сопутствующие услуги» ';
var $tender_name_kz = ' «2015.ОК-83424 Ұңғымаларды геофизикалық зерттеу, бұрғылап тесу қызметтері және ілеспе қызметтері» ';
...
var lots = [
  {
    kaz: "№ 1 лот - «Ұңғымаларды геофизикалық зерттеу, бұрғылап тесу қызметтері және ілеспе қызметтері»",
    rus: "лот №1 - «Услуги по геофизическому исследованию скважин, перфорированию и сопутствующие услуги»"
  },
  // {
...
documents.push(
  ...
  // Гарантийное письмо о соблюдении требования о сдаче отчетности по местному содержанию
	{
		template: '2',
		filename: 'ОсдачеОтчетностиПоМС',
		content_title_ru: 'Гарантийное письмо о сдаче отчетности по местному содержанию',
		content_title_kz: 'Жергілікті қамту бойынша есептілікті тапсыру туралы Кепілдік хат',
		content_doc_ru: 'Настоящим ТОО «' + $supplier_ru + '», участник открытого конкурса «' + $tender_name_ru + '» гарантирует соблюдать требования о сдаче отчетности по местному содержанию по формам в соответствии с законодательством Республики Казахстан  и нести ответственность за содержание информации отраженной в отчетах, нарушение сроков предоставления отчетности и несоблюдение обязательств по местному содержанию.',
		content_doc_kz: 'Осы хат арқылы «' + $tender_name_kz + '» ашық конкурсына қатысушы «' + $supplier_kz + '» ЖШС-гі жергілікті қамту бойынша есептілікті Қазақстан Республикасының заңнамасына сәйкес нысандар бойынша тапсыру туралы талаптарды орындауға және есеп беруде көрсетілген ақпараттардың мазмұны, есептілікті тапсыру мерзімінің бұзылу және жергілікті қамту бойынша міндеттемелердің қадағаланбауы үшін жауапты болуға кепілдік береді.',
    __proto__: head
	},
  
  // Гарантийное письмо об отсутствии оснований 81
  {
    template: '2',
    filename: 'Гар.Письмо 8',
    ...
    content_title_kz: 'Әлеуетті жеткізушінің өткізілетін ашық конкурсқа қатысуына тыйым салатын негіздердің жоқтығы туралы Кепіл хат',
    ...
    content_doc_kz: 'Осы хат арқылы «' + $tender_name_kz + '» ашық конкурсына қатысушы «' + $supplier_kz + '» ЖШС-гі  тарату (жою) немесе банкрот болу рәсімінде жоқ екеніне кепілдік береді.',
    __proto__: head
  }
 );
 // --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
